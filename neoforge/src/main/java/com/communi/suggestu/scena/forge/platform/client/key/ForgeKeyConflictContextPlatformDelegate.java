...
public class ForgeKeyConflictContextPlatformDelegate implements IKeyConflictContext
{
    ...
    private final net.neoforged.neoforge.client.settings.IKeyConflictContext delegate;

    public ForgeKeyConflictContextPlatformDelegate(final net.neoforged.neoforge.client.settings.IKeyConflictContext delegate) {this.delegate = delegate;}
    ...
    public net.neoforged.neoforge.client.settings.IKeyConflictContext getDelegate()
    {
        return delegate;
    }
}
